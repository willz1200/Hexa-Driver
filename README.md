...
* When running the motor at full speed the STM32 starts to hang because it doesn't have enough clock cycles per second to handle all of the encoder interrupts. An FPGA (LCMXO2-1200HC-4SG32C) could be used to track encoder movement and relieve the STM32.
